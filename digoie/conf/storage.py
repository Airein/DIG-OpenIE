...
__machine_learning_dir = os.path.join(__app_data_dir__, 'ml')
__ml_datasets_dir = os.path.join(__machine_learning_dir, 'datasets')
__ml_models_dir = os.path.join(__machine_learning_dir, 'models')
